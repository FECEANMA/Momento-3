...
const programmingBooks = [
   ...
   alert(`El libro You Don't Know JS se encuentra en la estanteria Nro: ${programmingBooks.indexOf("You Don't Know JS")}`);
   alert(`El libro You Don't Know JS se encuentra en la estanteria Nro: ${programmingBooks.findIndex(book => book == "You Don't Know JS")}`);